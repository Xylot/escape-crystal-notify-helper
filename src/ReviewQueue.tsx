...
export default function ReviewQueue({ drafts, snapshot, onClose, onEdit, onExport }: {
  drafts: Draft[]; snapshot: Snapshot; onClose: () => void;
  onEdit: (id: string) => void; onExport: (kind: string, ids: string[]) => void;
}) {
