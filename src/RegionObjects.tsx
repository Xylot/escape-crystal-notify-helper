...
import {chunkId} from './core/coordinates.mjs';
import type { Boss } from './types';

export default function RegionObjects({ boss, onUse, onError, selectedRegion, selectedPlane, selectedChunks = [], selectedIds = [], selectedObjectChunks = {}, autoLoad = false, lockedArea = false, gameval }: {
  selectedRegion?: number; selectedPlane?: number; selectedChunks?:number[]; boss: Boss; onUse: (id: string, placement: {x:number;y:number}) => void; onError: (message: string) => void; selectedIds?: string[]; selectedObjectChunks?:Record<string,number[]>; autoLoad?: boolean; lockedArea?: boolean;gameval:GamevalLookup;
}) {
