...
import {gamevalCodeId} from './gameval-code.mjs';
...
export function validateEntrance(e) {
  ...
  for(const id of e.ids) {
    ...
    if(e.objectType==='NPC'&&/^ObjectID1?\./.test(id)||e.objectType==='GAME_OBJECT'&&id.startsWith('NpcID.'))throw new Error('Entrance ID namespace does not match its object type.');
  }
