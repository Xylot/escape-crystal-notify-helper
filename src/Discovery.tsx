...
export default function Discovery(p: Props) {
  ...
  return <section className={`discovery ${p.filter === 'drafts' ? 'drafts-view' : ''}`} aria-label="Encounter library">
    ...
    </div><footer className="discovery-footer"><span><Icon name="spark" size={14}/> Every contribution makes Gielinor a little safer.</span><a href="https://oldschool.runescape.wiki/w/Boss" target="_blank" rel="noreferrer">Encounter data & portraits · OSRS Wiki <Icon name="external" size={12}/></a></footer>
  </section>;
}
