...
for(const file of ['encounter-kind.mjs','encounter-export.mjs','encounter-metadata.mjs','item-icon.mjs','item-ids.mjs','item-labels.mjs','coordinates.mjs','java.mjs','proposal.mjs','entrance.mjs','gameval-code.mjs','gameval-ids.mjs'])await copyFile(`src/core/${file}`,path.join(base,'src/core',file));
