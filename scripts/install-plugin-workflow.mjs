...
for(const file of ['encounter-kind.mjs','encounter-export.mjs','coordinates.mjs','java.mjs','proposal.mjs','entrance.mjs'])await copyFile(`src/core/${file}`,path.join(base,'src/core',file));
